...
// Then, you can create a new string with only the characters between these two
// positions.
...
/*
 * We want to make a helper function to count the arguments/ strings inside a
 * string for proper allocation
 * */
